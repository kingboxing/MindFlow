...
from scipy.sparse import isspmatrix_csc,isspmatrix, bmat
...
class MatInv(LinearOperator):
    ...
    lusolver: string, indicate solver type
        'mumps': using FEniCS build-in solver (1)
        'superlu': using scipy.sparse.splu (3)
        'umfpack': using scipy.sparse.factorize with Umfpack=True (6)
