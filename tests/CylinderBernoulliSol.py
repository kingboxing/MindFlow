...
model.boundary.define(mark = 3, name = 'Inlet', locs = 'on_boundary and x[0] < 0.0 + tol and not (between(x[0], (-0.5, 0.5)) and between(x[1], (-0.5, 0.5)))')
model.boundary.define(mark = 4, name = 'Outlet', locs = 'on_boundary and near(x[0], 23.0, tol)')
model.boundary.define(mark = 5, name = 'Cylinder', locs = 'on_boundary and between(x[0], (-0.5, 0.5)) and between(x[1], (-0.5, 0.5))')
