...
class ResolventAnalysis(FreqencySolverBase):
    ...
    def _initialize_solver(self, bound=None):
        ...
        if param['method'] == 'lu':
            ...
            self.LinvH = InverseMatrixOperator(self.LHS, A_lu=self.Linv.A_lu, lusolver=param['lusolver'], trans='H', echo=param['echo'])
    ...
    def _initialize_expr(self, bound=None):
        ...
        self.expr = spla.aslinearoperator(PM.transpose()) * self.LinvH * spla.aslinearoperator(PQPT) * self.Linv * spla.aslinearoperator(PM)
